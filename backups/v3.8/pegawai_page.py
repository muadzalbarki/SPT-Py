...
class PegawaiPage(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.btn_import = ModernButton("Import Excel", icon="import", variant="outline")
        self.btn_import.setMinimumWidth(140)
        toolbar.addWidget(self.btn_import)

        self.btn_export = ModernButton("Export", icon="export", variant="ghost")
        toolbar.addWidget(self.btn_export)

        self.btn_hapus = ModernButton("Hapus", icon="delete", variant="danger")
