from PySide6.QtWidgets import (
    ...
    QMessageBox, QProgressBar, QFrame, QPushButton,
)
...
class GeneratePage(QWidget):
    ...
    def _build_page0(self):
        ...
        btn_all.setFont(QFont("Inter", 12, QFont.Weight.Medium))
        ...
        btn_none.setFont(QFont("Inter", 12, QFont.Weight.Medium))
        btn_none.setCursor(Qt.CursorShape.PointingHandCursor)
        btn_none.setMinimumHeight(36)
        ...
        layout.addWidget(self.peserta_checklist, 1)
